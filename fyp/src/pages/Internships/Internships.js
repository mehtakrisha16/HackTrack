...
const Internships = () => {
  ...
  const allInternships = React.useMemo(() => {
    ...
    const staticInternships = getOpportunitiesByType('internship').map(internship => ({
      ...
      location: typeof internship.location === 'string' ? internship.location : (internship.location?.city || 'Remote'),
    ...
    const scrapedInternships = realInternships.map(internship => ({
      ...
      applicationLink: internship.applicationLink || internship.registrationLink,
      registrationLink: internship.registrationLink || internship.applicationLink,
      applyLink: internship.applyLink,
      url: internship.sourceUrl || internship.applicationLink,
